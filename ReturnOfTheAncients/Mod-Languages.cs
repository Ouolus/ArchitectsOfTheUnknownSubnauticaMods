namespace RotA
{
    ...
    public partial class Mod
    {
        ...
        const string ency_buildablesonicdeterrent = "BuildableSonicDeterrentEncy";
        ...
        static void PatchLanguage()
        {
            ...
            LanguageHandler.SetLanguageLine(ionKnifeOmegaCube, "Omega cube: Incredibly powerful and emits a bright light.\nThe blade can be charged to force any object in contact with it to experience a massive influx of kinetic energy. Reason unknown.");
        ...
        static void PatchEncys()
        {
            ...
            PatchEncy(ency_precblade, modEncyPath_relics, "Alien Knife", "An alien knife with obvious applications. The material that composes the blade cannot be identified. It has some resemblance to an Ion Cube, but is a different color and appears to contain several times as much energy. Further research required.", "OmegaBlade_Popup", "OmegaBlade_Ency");
            ...
            PatchEncy(ency_aquariumSkeleton, modEncyPath_analysis, "Encased Gargantuan Skeleton", "The skeletal remains of a leviathan specimen, encased in a sealed environment, with few signs of decay. Judging by the bone structure and density, it was likely a juvenile specimen. Carbon dating suggests it has died approximately one thousand years ago.\n\nRelative intactness of the bones suggests it has died of starvation or another natural cause. It was likely abandoned after a certain event.\n\nInterestingly, the ancient ecosystem inside the tank is still thriving, and has no signs of Kharra affecting it.");

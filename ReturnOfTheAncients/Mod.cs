...
namespace RotA
{
    ...
    public class Mod
    {
        ...
        public static void Patch()
        {
            ...
            PatchEncy(ency_warpCannonTerminal, modEncyPath_tech, "Handheld Warping Device Schematics", "This terminal contains schematics for alien warp technology, which utilizes the unnatural properties of Electricubes. As a result of this finding, your PDA has synthesized blueprints for a Handheld Warping Device.\n\nWarping Device Operation:\nEnergy is quickly routed through the system from the battery up into the barrel, where it can be released in a controlled pulse. The magnitude and effects of this pulse can be adjusted by precise mechanical rotations to the four calibration discs. These pulses generate a warping field that transports atoms from a point to another at extremely fast speeds. Practical uses include personal teleportation and manipulation of the state of objects in the environment.", "WarpCannon_Popup", "WarpCannon_Ency");

...
namespace RotA
{
    ...
    public class Mod
    {
        ...
        public static void Patch()
        {
            ...
            signal_kooshZoneBase = new GenericSignalPrefab("KooshZoneBaseSignal", "Precursor_Symbol05", "Downloaded co-ordinates", alienSignalName, new Vector3(0f, 0f, 0f), 3); //purple tablet icon

...
namespace RotA.Prefabs
{
    public class AdultGargantuan : GargantuanBase
    {
        ...
        public override ScannableItemData ScannableSettings => new ScannableItemData(true, 10f, Mod.modEncyPath_creatures, Mod.assetBundle.LoadAsset<Sprite>("Adult_Popup"), Mod.assetBundle.LoadAsset<Texture2D>("Adult_Ency"));

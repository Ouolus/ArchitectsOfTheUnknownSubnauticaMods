...
namespace ArchitectsLibrary.Buildables
{
    class BuildableColumnSmall : GenericPrecursorDecoration
    {
        ...
        protected override OrientedBounds[] GetBounds => new OrientedBounds[] { new OrientedBounds(new Vector3(0f, 4f * 0.37f, 0f), Quaternion.identity, new Vector3(1f * 0.37f, 3.7f * 0.37f, 1f * 0.37f)) };

...
namespace ArchitectsLibrary.Buildables
{
    class BuildableRelicTank : GenericPrecursorDecoration
    {
        ...
        protected override OrientedBounds[] GetBounds => new OrientedBounds[] { new OrientedBounds(new Vector3(0f, 0.5f, 0f), Quaternion.identity, new Vector3(0.4f, 0.6f, 0.4f))};

...
namespace ArchitectsLibrary.Buildables
{
    ...
    {
        public BuildablePedestalLarge() : base("BuildablePedestalLarge", "Tall Alien Pedestal", "A large pedestal that can be used for decoration. Placeable inside and outside.")
        {
        }

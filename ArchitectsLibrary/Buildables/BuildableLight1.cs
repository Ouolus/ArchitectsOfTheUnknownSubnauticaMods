...
namespace ArchitectsLibrary.Buildables
{
    ...
    {
        public BuildableLight1() : base("BuildablePrecursorLight1", "Large Alien Activated Light", "A decorational light, that activates within range. Placeable inside and outside.")
        {
        }

        protected override ConstructableSettings GetConstructableSettings => new ConstructableSettings(false, false, true, false, true, true, true, placeDefaultDistance: 2f, placeMinDistance: 2f, placeMaxDistance: 10f);

...
namespace ProjectAncients.Prefabs.AlienBase
{
    public class TeleporterPrimaryPrefab : Spawnable
    {
        ...
        public TeleporterPrimaryPrefab(string classId, string teleporterId, Vector3 teleportPosition, float teleportAngle, bool disablePlatform, bool useAlternateColorScheme) : base(classId, "", "")
        {
            frame = new TeleporterFramePrefab(string.Format("{0}Frame", classId), teleporterId, teleportPosition, teleportAngle, disablePlatform, useAlternateColorScheme);
            frame.Patch();
        }

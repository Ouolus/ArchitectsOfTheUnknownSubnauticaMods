...
namespace ProjectAncients.Mono.AlienBaseSpawners
{
    public abstract class SecondaryBaseSpawner : AlienBaseSpawner
    {
        ...
        public override IEnumerator ConstructBase()
        {
            ...
            yield return StartCoroutine(SpawnPrefab(light_big_animated, new Vector3(centerLocalX - 3f, -3.17f + 0.48f, -5f), ceilingLightRotation));
            yield return StartCoroutine(SpawnPrefab(light_big_animated, new Vector3(centerLocalX + 3f, -3.17f + 0.48f, -5f), ceilingLightRotation));
            ...
            yield return StartCoroutine(SpawnPrefab(light_big_animated, new Vector3(centerLocalX + 18f, -3.17f, 0f), ceilingLightRotation));
            yield return StartCoroutine(SpawnPrefab(light_big_animated, new Vector3(centerLocalX - 10f, -3.17f, 0f), ceilingLightRotation));
            yield return StartCoroutine(SpawnPrefab(light_big_animated, new Vector3(centerLocalX - 18f, -3.17f, 0f), ceilingLightRotation));

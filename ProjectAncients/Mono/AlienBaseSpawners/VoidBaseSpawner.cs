...
namespace ProjectAncients.Mono.AlienBaseSpawners
{
    public class VoidBaseSpawner : AlienBaseSpawner
    {
        ...
        public override IEnumerator ConstructBase()
        {
            ...
            yield return SpawnPrefab(light_volumetric_1, new Vector3(0f, 10, 62.5f), Vector3.zero, new Vector3(1f, 1f, 1f));
            yield return SpawnPrefab(light_volumetric_1, new Vector3(0f, 21, 62.5f), Vector3.zero, new Vector3(1f, 2f, 1f));
            yield return SpawnPrefab(light_volumetric_1, new Vector3(0f, 32, 62.5f), Vector3.zero, new Vector3(1f, 1f, 1f));

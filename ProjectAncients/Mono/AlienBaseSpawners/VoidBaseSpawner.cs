...
namespace ProjectAncients.Mono.AlienBaseSpawners
{
    public class VoidBaseSpawner : AlienBaseSpawner
    {
        ...
        public override IEnumerator ConstructBase()
        {
            ...
            yield return SpawnPrefab(vfx_entrance, new Vector3(-0.5f, 3f+ platformY, 62f), new Vector3(90, 0, 0), new Vector3(1.30f, 1.5f, 1f));
            ...
            yield return SpawnPrefab(light_verybig_novolumetrics, new Vector3(-17f, 7, 62.5f), Vector3.right * 90f, Vector3.one * 2f);
            yield return SpawnPrefab(light_volumetric_1, new Vector3(0f, 16, 62.5f), Vector3.one * 2f);
            yield return SpawnPrefab(light_volumetric_1, new Vector3(0f, 28, 62.5f), Vector3.one * 2f);

...
namespace ProjectAncients.Mono.AlienBaseSpawners
{
    public class VoidBaseSpawner : AlienBaseSpawner
    {
        public override void ConstructBase()
        {
            ...
            SpawnPrefab(light_big_animated, new Vector3(0f, 0f, 36f), new Vector3(0f, -0.5f, 0f));
            ...
            SpawnPrefabsArray(light_big_animated, 2f, new Vector3(1, 1, 8), Vector3.one, new Vector3(-7f + 0.5f, 0.5f, 14f));
            SpawnPrefabsArray(light_big_animated, 2f, new Vector3(1, 1, 8), Vector3.one, new Vector3(7f + 1.5f, 0.5f, 14f));

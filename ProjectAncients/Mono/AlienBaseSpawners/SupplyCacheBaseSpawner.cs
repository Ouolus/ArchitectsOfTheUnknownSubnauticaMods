...
namespace ProjectAncients.Mono.AlienBaseSpawners
{
    public class SupplyCacheBaseSpawner : SecondaryBaseSpawner
    {
        public override void ConstructBase()
        {
            ...
            SpawnRelicInCase(new Vector3(8f, floorLocalY, 15f), Mod.ingotRelic.ClassID, new Vector3(0f, 1.25f, 0f));
            SpawnRelicInCase(new Vector3(8f, floorLocalY, 17f), Mod.ingotRelic.ClassID, new Vector3(0f, 1.25f, 0f));
            SpawnRelicInCase(new Vector3(8f, floorLocalY, 19f), Mod.ingotRelic.ClassID, new Vector3(0f, 1.25f, 0f));
            SpawnRelicInCase(new Vector3(-8f, floorLocalY, 15f), Mod.ingotRelic.ClassID, new Vector3(0f, 1.25f, 0f));
            SpawnRelicInCase(new Vector3(-8f, floorLocalY, 17f), Mod.ingotRelic.ClassID, new Vector3(0f, 1.25f, 0f));
            SpawnRelicInCase(new Vector3(-8f, floorLocalY, 19f), Mod.ingotRelic.ClassID, new Vector3(0f, 1.25f, 0f));
        }

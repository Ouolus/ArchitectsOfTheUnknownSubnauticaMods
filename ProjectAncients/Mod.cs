...
namespace ProjectAncients
{
    ...
    public class Mod
    {
        ...
        public static void Patch()
        {
            ...
            PatchEncy(ency_archElectricityTerminal, modEncyPath, "Electromagnetic Nanotechnology", "This data terminal contains the blueprints for an advanced nanotechnology used to generate a powerful charge with a distinctive green glow. The applications of this medium include transferring high amounts of energy and incapacitating large fauna.\n\nThis phenomenon appears to be consistent with other advanced technology found on the planet.\n\nYour PDA has generated several new upgrade blueprints which exploit this discovery.");
